...
interface LoadUiState {
    ...
    fun show(errorText: TextView, retryButton: RetryButton, progressUi: MyProgress) = Unit
    ...
    abstract class Abstract(
        ...
        override fun show(errorText: TextView, retryButton: RetryButton, progressUi: MyProgress) {
